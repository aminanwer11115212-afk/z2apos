                ...
                <tr key={l.part.id}>
                  ...
                  <td className="p-2">
                    <div className="flex items-center justify-center gap-1">
                      <button
                        onClick={() => onQty(l.part.id, l.qty - 1)}
                        className="w-7 h-7 rounded border hover:bg-muted"
                      >
                  ...
                  <td className="p-2">
                    <div className="relative">
                      ...
                      />
                      {!canEditPrice && (
                        <Lock className="w-3 h-3 absolute left-1 top-2 text-muted-foreground" />
                      )}
                    </div>
                  </td>
