            ...
            return (
              <li key={h.id} className="flex items-center justify-between gap-2 border rounded-lg p-2.5 bg-muted/30">
                ...
                <div className="flex gap-1 shrink-0">
                  <Btn onClick={() => onResume(h)} className="h-8 text-xs px-3">استعادة</Btn>
                  <button onClick={() => onDrop(h.id)} className="w-8 h-8 rounded border text-destructive hover:bg-destructive/10">
