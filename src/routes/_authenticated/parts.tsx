    ...
    <div className="p-4 lg:p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-4">
        <SearchBar
          value={q}
          onChange={setQ}
          placeholder="بحث بالكود، الاسم، الفئة، نوع السيارة..."
        />
      </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          title="لا توجد قطع بعد"
          action={isAdmin && <Btn onClick={openNew}>إضافة أول صنف</Btn>}
        />
      ) : (
                    ...
                    <tr key={p.id} className="border-t hover:bg-muted/50">
                      ...
                      {isAdmin && (
                        <td className="p-3 whitespace-nowrap">
                          ...
                          <button
                            onClick={() => {
                              if (confirm("حذف هذا الصنف؟")) del.mutate(p.id);
                            }}
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="نوع السيارة">
              <Input
                ...
                placeholder="مثلاً: تويوتا كورولا"
              />
            </Field>
            <Field label="الفئة">
              <Input
